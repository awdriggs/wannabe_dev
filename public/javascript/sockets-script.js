...
socket.on('trade', function(tradeObj) {
    //format the price of the trade
    price = parseFloat(tradeObj.stock_price).toFixed(2);
    ...
    tradeDiv.append('<p> Stock:'+ tradeObj.stock_name + ' Spread: $' + tradeObj.spread +  ' New Price: $' + price + '</p>')
